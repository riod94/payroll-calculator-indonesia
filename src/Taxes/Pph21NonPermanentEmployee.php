...
class Pph21NonPermanentEmployee extends AbstractPph
{
    ...
    {
        if ($this->calculator->result->earnings->monthly->gross > 0 && $this->calculator->employee->taxable) {
            ...
            $this->result->pph->pkp = $this->roundDownPkp(
                $this->calculator->result->earnings->annualy->gross - $this->result->pph->ptkp->amount
            );

            // Calculate PPh for Non Permanent Employee
